...
function(a, b, c, d) {
  ...
  Foundation.libs.tab = {
    ...
    init: function(a, c, d) {
      var e = this,
        f = this.S;
      this.bindings(c, d), this.handle_location_hash_change(), f("[" + this.attr_name() + "] > .active > a", this.scope).each(function() {
      ...
      var g = this,
        ...
        q = function(a) {
          var c = b.location.href === g.entry_location,
            d = o.scroll_to_content ? g.default_tab_hashes[0] : "fndtn-" + g.default_tab_hashes[0].replace("#", "");
